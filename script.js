...
var animate = function () {
  ...
  function hasUnsubscribed() {
    ...
    TweenMax.to(eyebrowSadLeft, speed, { y: 10 });
    TweenMax.to(eyebrowSadRight, speed, { y: 10 });
    title.innerHTML = "HARI INI GABAIK YA SAYANG!";
    subtitle.innerHTML = "JUST SAY GAPAPA,KAMU GA STUK HARI INI AJA HARI BAIK AKAN DATANG KOK.";
  ...
  function hasCancelled() {
    ...
    title.innerHTML = "YEYY COBA CERITA IN SEMUANYA !";
    subtitle.innerHTML = "JANGAN LUPA SATU PERSATU KAMU KASI TAU BAIKNYA YAAA";
    unsubscribeButton.style.display = 'none';
    cancelButton.style.display = 'none';
    goBackButton.style.display = 'block';
    clicked = true;
